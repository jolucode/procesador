...
```
cd existing_repo
git remote add origin https://gitlab.com/v_soluciones/procesador.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/v_soluciones/procesador/-/settings/integrations)
