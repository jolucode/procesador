...
public interface BillService {
    ...
    public service.cloud.request.clientRequest.proxy.ose.object.StatusResponse getStatus(
    ...
    @RequestWrapper(localName = "sendPack", targetNamespace = "http://service.sunat.gob.pe", className = "pservice.cloud.request.clientRequest.proxy.ose.object.SendPack")
    @ResponseWrapper(localName = "sendPackResponse", targetNamespace = "http://service.sunat.gob.pe", className = "service.cloud.request.clientRequest.proxy.ose.object.SendPackResponse")
    @WebResult(name = "ticket", targetNamespace = "")
