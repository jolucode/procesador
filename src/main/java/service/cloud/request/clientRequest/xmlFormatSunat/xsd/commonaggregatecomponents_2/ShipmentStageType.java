...
public class ShipmentStageType implements Serializable {
     ...
     *
     * @param aList The new list member to set. May be <code>null</code>.
     */
     ...
     * Created by ph-jaxb22-plugin -Xph-list-extension
     *
     * @return <code>true</code> if at least one item is contained, <code>false</code> otherwise.
     */
     ...
     * Created by ph-jaxb22-plugin -Xph-list-extension
     *
     * @return <code>true</code> if no item is contained, <code>false</code> otherwise.
     */
    ...
    public int getgetInstructionsCount() {
     ...
     * @return The element at the specified index. May be <code>null</code>
     ...
     * Created by ph-jaxb22-plugin -Xph-list-extension
     *
     * @param elem The element to be added. May not be <code>null</code>.
     */
    ...
    public int getgetDemurrageInstructionsCount() {
    ...
    public int getgetCarrierPartyCount() {
    ...
    public int getgetFreightAllowanceChargeCount() {
    ...
    public int getgetDetentionTransportEventCount() {
    ...
    public int getgetRequestedWaypointTransportEventCount() {
    ...
    public int getgetPlannedWaypointTransportEventCount() {
    ...
    public int getgetTransportEventCount() {
    ...
    public int getgetPassengerPersonCount() {
    ...
    public int getgetDriverPersonCount() {
    ...
    public int getgetCrewMemberPersonCount() {
     ...
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained IDType object or <code>null</code>
     */
     ...
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained TransportModeCodeType object or <code>null</code>
     */
     ...
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained TransportMeansTypeCodeType object or <code>null</code>
     */
    ...
    /**
     * Get the value of the contained TransitDirectionCodeType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained TransitDirectionCodeType object or <code>null</code>
     */
    ...
    /**
     * Get the value of the contained PreCarriageIndicatorType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @param nullValue The value to be returned, if the owning object is <code>null</code
     * @return Either the value of the contained PreCarriageIndicatorType object or the passed nullValue
     */
    ...
    /**
     * Get the value of the contained OnCarriageIndicatorType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @param nullValue The value to be returned, if the owning object is <code>null</code
     * @return Either the value of the contained OnCarriageIndicatorType object or the passed nullValue
     */
    ...
    /**
     * Get the value of the contained EstimatedDeliveryDateType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained EstimatedDeliveryDateType object or <code>null</code>
     */

    public XMLGregorianCalendar getEstimatedDeliveryDateValue() {
        EstimatedDeliveryDateType aObj = getEstimatedDeliveryDate();
        return ((aObj == null) ? null : aObj.getValue());
    }

    /**
     * Get the value of the contained EstimatedDeliveryTimeType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained EstimatedDeliveryTimeType object or <code>null</code>
     */

    public XMLGregorianCalendar getEstimatedDeliveryTimeValue() {
        EstimatedDeliveryTimeType aObj = getEstimatedDeliveryTime();
        return ((aObj == null) ? null : aObj.getValue());
    }

    /**
     * Get the value of the contained RequiredDeliveryDateType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained RequiredDeliveryDateType object or <code>null</code>
     */

    public XMLGregorianCalendar getRequiredDeliveryDateValue() {
        RequiredDeliveryDateType aObj = getRequiredDeliveryDate();
        return ((aObj == null) ? null : aObj.getValue());
    }

    /**
     * Get the value of the contained RequiredDeliveryTimeType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained RequiredDeliveryTimeType object or <code>null</code>
     */

    public XMLGregorianCalendar getRequiredDeliveryTimeValue() {
        RequiredDeliveryTimeType aObj = getRequiredDeliveryTime();
        return ((aObj == null) ? null : aObj.getValue());
    }

    /**
     * Get the value of the contained LoadingSequenceIDType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained LoadingSequenceIDType object or <code>null</code>
     */
    ...
    /**
     * Get the value of the contained SuccessiveSequenceIDType object
     * Created by ph-ubl-jaxb-plugin -Xph-ubl-value
     *
     * @return Either the value of the contained SuccessiveSequenceIDType object or <code>null</code>
     */
