...
import service.cloud.request.clientRequest.xmlFormatSunat.xsd.commonbasiccomponents_2.CodigoType;
import service.cloud.request.clientRequest.xmlFormatSunat.xsd.commonbasiccomponents_2.ValorType;
...
public class DatoAdicionalType {
    ...
    @XmlElement(name = "Codigo", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected CodigoType codigo;

    @XmlElement(name = "Valor", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected ValorType valor;

    public CodigoType getCodigo() {
        return codigo;
    }

    public void setCodigo(CodigoType codigo) {
        this.codigo = codigo;
    }
    ...
    public void setValor(ValorType valor) {
        this.valor = valor;
    }
}
