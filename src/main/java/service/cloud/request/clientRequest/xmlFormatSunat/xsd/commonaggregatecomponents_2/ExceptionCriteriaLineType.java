 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}ResolutionCode" maxOccurs="unbounded" minOccurs="0"/>
...
public class ExceptionCriteriaLineType {
    ...
    protected List<ResolutionCodeType> resolutionCode;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the resolutionCode property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getResolutionCode().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     */
    public List<ResolutionCodeType> getResolutionCode() {
        if (resolutionCode == null) {
            resolutionCode = new ArrayList<ResolutionCodeType>();
        }
