...
/**
 * Esta clase contiene la informacion de la nota de credito que se colocara en
 * el template del PDF de tipo NOTA DE CREDITO.
 *
...
public class CreditNoteObject {
    ...
    /* Informacion de la nota de credito */
    ...
    /* Lista de items */
    //private List<CreditNoteItemObject> creditNoteItems;
    ...
    public void setC1(String c1) { C1 = c1; }

    public String getC2() { return C2; }

    public void setC2(String c2) { C2 = c2; }

    public String getC3() { return C3; }

    public void setC3(String c3) { C3 = c3; }

    public String getF1() { return F1; }

    public void setF1(String f1) { F1 = f1; }

    public String getF2() {  return F2; }

    public void setF2(String f2) { F2 = f2; }

    public String getF3() { return F3; }

    public void setF3(String f3) { F3 = f3; }

    public BigDecimal getM1() { return M1; }

    public void setM1(BigDecimal m1) { M1 = m1; }

    public BigDecimal getM2() { return M2; }

    public void setM2(BigDecimal m2) { M2 = m2; }

    public BigDecimal getM3() { return M3; }

    public void setM3(BigDecimal m3) { M3 = m3; }

    public int getTotalCuotas() { return totalCuotas; }

    public void setTotalCuotas(int totalCuotas) { this.totalCuotas = totalCuotas; }
    ...
    /**
     * Constructor basico de la clase CreditNoteObject.
     */
    ...
    public String getTypeOfCreditNote() {
        return typeOfCreditNote;
    } //getTypeOfCreditNote

    public void setTypeOfCreditNote(String typeOfCreditNote) {
        this.typeOfCreditNote = typeOfCreditNote;
    } //setTypeOfCreditNote

    public String getDescOfCreditNote() {
        return descOfCreditNote;
    } //getDescOfCreditNote

    public void setDescOfCreditNote(String descOfCreditNote) {
        this.descOfCreditNote = descOfCreditNote;
    } //setDescOfCreditNote
    ...
    //public List<CreditNoteItemObject> getCreditNoteItems() {
        //return creditNoteItems;
    //} //getCreditNoteItems

    //public void setCreditNoteItems(List<CreditNoteItemObject> creditNoteItems) {
    ...
    public List<WrapperItemObject> getItemListDynamicC() { return itemListDynamicC; }

    public void setItemListDynamicC(List<WrapperItemObject> itemListDynamicC) { this.itemListDynamicC = itemListDynamicC; }
