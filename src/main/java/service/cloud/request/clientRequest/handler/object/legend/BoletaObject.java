...
import service.cloud.request.clientRequest.handler.object.WrapperItemObject;
import service.cloud.request.clientRequest.handler.object.item.BoletaItemObject;
...
/**
 * Esta clase contiene la informacion de la boleta de venta que se colocara en
 * el template del PDF de tipo BOLETA.
 *
 * @author Jose Manuel Lucas Barrera (josemlucasb@gmail.com)
 */
public class BoletaObject {
    /* Informacion general */
    ...
    /* Lista de items */
    private List<BoletaItemObject> boletaItems;
    ...
    private String impuestoBolsa;

    private String impuestoBolsaMoneda;
    ...
    /**
     * Constructor basico de la clase BoletaObject.
     */
    public BoletaObject() {
    }
    ...
    public List<BoletaItemObject> getBoletaItems() {
        return boletaItems;
    } //getBoletaItems

    public void setBoletaItems(List<BoletaItemObject> boletaItems) {
        this.boletaItems = boletaItems;
    } //setBoletaItems
    ...
    public List<WrapperItemObject> getItemsDynamic() {
        return itemsListDynamic;
    }

    public void setItemsDynamic(List<WrapperItemObject> itemsDynamic) {
        this.itemsListDynamic = itemsDynamic;
    }
    ...
    public void setPrepaidAmountValue(String prepaidAmountValue) {
        PrepaidAmountValue = prepaidAmountValue;
    }

    public String getPorcentajeISC() {
        return porcentajeISC;
    }

    public void setPorcentajeISC(String porcentajeISC) {
